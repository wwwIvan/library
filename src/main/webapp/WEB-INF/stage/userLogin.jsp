...
<div id="loginbox">
    <form id="loginform" class="form-vertical" action="${pageContext.request.contextPath}/stage/login">
        <div class="control-group normal_text"><h3>Library User Login</h3></div>
        ...
        <div class="form-actions">
            <span class="pull-left"><a href="${pageContext.request.contextPath}/stage/registerUI" class="flip-link btn btn-warning">注册</a></span>
        ...
        $("#loginform").validate({
            rules:{
                ...
                password: {
                    ...
                    remote:{
                        type:"post",
                        url:"${pageContext.request.contextPath}/stage/check",
                        data:{
                            account:function () {
                                return $("#account").val();
                            },
